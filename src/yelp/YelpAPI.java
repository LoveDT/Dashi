...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "ajGkwV6ct4NBL-xcey1e8w";
    private static final String CONSUMER_SECRET = "WSoAA9Ey6CQZCHBOU__4lsOxYRE";
    private static final String TOKEN = "hRryRc2ky0DAhzHENb2V3_LtcfHHlUPK";
    private static final String TOKEN_SECRET = "nRqa4ubZ2G9TG81RKv7Kf_6zMM4";
