...
public class RestaurantTest {
	...
	public void testStringToJSONArray() {
		...
		//testArray.put(",");
		//assertTrue(jsonArrayStringEquals(testArray, Restaurant.stringToJSONArray(",")));
		testArray.put("");
		assertTrue(jsonArrayStringEquals(testArray, Restaurant.stringToJSONArray("")));
		testArray.put("Chinese");
		assertTrue(jsonArrayStringEquals(testArray, Restaurant.stringToJSONArray("Chinese")));
		testArray.put("");
		assertTrue(jsonArrayStringEquals(testArray, Restaurant.stringToJSONArray(",Chinese,")));
		testArray.put("Italian");
		assertTrue(jsonArrayStringEquals(testArray, Restaurant.stringToJSONArray("Italian,,Chinese,")));
	}
